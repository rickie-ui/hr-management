...
<section class="mx-10 h-screen">
    <h3 class="text-xl">Salary Information</h3>
    <p class="text-sm my-1"><span class="text-[#405189]">Verizon</span> <span class="opacity-50">/ Account / Information</span></p>
     ...
     <div class="my-10 py-10 px-10 bg-white rounded-sm flex space-x-8">
        ...
        <div class="w-9/12 border-2 rounded-md p-4">
          ...
          <form action="/admin/{{$user->id}}/payroll" method="POST" enctype="multipart/form-data" >
              ...
              <div class=" flex space-x-4">
                        <div class="w-full">
                            ...
                            <input type="text" class="w-full border-2 px-4 py-2 rounded-md outline-none bg-[#F3F8FB]" name="fullName" value="{{$user->fullName}}" disabled>
                             @error('fullName')
                ...
                <div class=" flex space-x-4">
                        <div class="w-full">
                            ...
                            <input type="text" class="w-full border-2 px-4 py-2 rounded-md outline-none bg-[#F3F8FB]" name="email" value="{{$user->email}}" disabled>
                             @error('email')
                                <div class="text-red-500 text-sm">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" class="w-full border-2 px-4 py-2 rounded-md outline-none bg-[#F3F8FB]" name="phone" value="{{$user->detail->phone ?? ''}}" disabled>
                             @error('phone')
                                <div class="text-red-500 text-sm">
                                    {{ $message }}
                                </div>
                ...
                <h3 class="opacity-60  my-8">Payment Settings</h3>
                 ...
                 <div class="w-full">
                            ...
                            <input type="text" class="w-full border-2 px-4 py-2 rounded-md outline-none focus:bg-[#F3F8FB]" name="salary" value="{{$user->salary}}">
                                @error('salary')
                                    <div class="text-red-500  text-sm">
                                        {{ $message }}
                                    </div>
